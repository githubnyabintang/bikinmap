    ...
    return (
        <div className="absolute bottom-8 left-8 z-[1000] flex items-end gap-3">
            ...
            <div className={`flex items-end gap-3 transition-all duration-500 origin-bottom-left ${isCollapsed ? 'opacity-0 scale-y-0 translate-y-10 pointer-events-none absolute left-12 bottom-0' : 'opacity-100 scale-y-100 translate-y-0 relative'}`}>
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-2 shadow-2xl border border-white/40 flex items-center gap-4 whitespace-nowrap mb-1">
            ...
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 flex-1 flex flex-col py-8">
                ...
                <div className="bg-white rounded-[48px] shadow-2xl shadow-sigappa-navy/5 border border-slate-100 overflow-hidden mb-8 p-6">
                    ...
                    <div className="relative w-full h-[70vh] overflow-hidden z-10">
                        ...
                        <div className={`absolute top-8 bottom-8 right-8 w-[400px] max-w-[calc(100%-64px)] bg-white/95 backdrop-blur-xl rounded-[40px] shadow-2xl z-[1100] p-8 overflow-y-auto transition-transform duration-700 border border-white/60 ${!sidebarPkm ? 'translate-x-[120%]' : 'translate-x-0'}`}>
                            {sidebarPkm && (
                                <div className="space-y-8 animate-in fade-in slide-in-from-right-8 duration-500">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex flex-col gap-3 text-[12px] font-bold text-slate-400 uppercase tracking-widest">
                                            <div className="flex items-center gap-3"><div className="w-8 h-8 rounded-lg bg-sigappa-primary/10 text-sigappa-primary flex items-center justify-center"><i className="fa-solid fa-location-dot"></i></div> {sidebarPkm.kecamatan}, {sidebarPkm.kabupaten}</div>
